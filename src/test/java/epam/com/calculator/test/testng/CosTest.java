...
public class CosTest extends TestngBaseTest {
    ...
    @Test(dataProvider = "DataProviderForCosTest", groups = {"Broken"})
    public void cosTest (String a, String b, boolean result) {
        SoftAssert softAssert = new SoftAssert();
        softAssert.assertEquals(FormatHelper.round(calculator.cos(FormatHelper.convertStringDouble(a))) == FormatHelper.convertStringDouble(b),
